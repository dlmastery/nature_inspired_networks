...
<title>NaturePriorBlock — autoresearch dashboard</title>
<style>
...
def render_dashboard(results_dir: str | Path, out_html: Path,
                     ...
                     subtitle: str = "nature-inspired ablations on CIFAR-10 + topology / CKA / Pareto") -> None:
    ...
    for img, cap in [
        ...
        (ablate_png.name, "Ablation matrix: each nature-inspired prior toggled independently"),
    ]:
    ...
    html.append("<div class='meta'>Generated by nature_inspired_networks.dashboard.</div>")
