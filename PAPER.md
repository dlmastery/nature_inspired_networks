...
- **3-seed re-runs at the best config found.** Single-seed differences on CIFAR-10 12-ep are within seed noise up to **2σ_pooled ≈ 1.21 pp** (pooled empirical σ = 0.607 pp across 11 multi-seed tags; the previous "±0.5 pp" rule of thumb is OPTIMISTIC — see [`STATISTICAL_TESTS.md`](STATISTICAL_TESTS.md) §4.1). Phase-9 hill-climb requires **n ≥ 7 seeds** at the best config to clear Holm-Bonferroni α'=0.0167 across the k=3 Phase-8 family.
